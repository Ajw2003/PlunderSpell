...
BRONZE_CASTLE_SPECS = [
    ...
    dict(key="BronzeWallCorner", builder="build_bronze_wall_corner", tri_budget=1200, subdir="Castle/BronzeAge", module="castle_builders_bronze_curtain", era="BronzeAge", zone="CurtainWall", kind="wall"),
    ...
    dict(key="BronzeTreasury", builder="build_bronze_treasury", tri_budget=1600, subdir="Castle/BronzeAge", module="castle_builders_bronze_keep", era="BronzeAge", zone="Keep", kind="room"),
    ...
    dict(key="BronzeTholos", builder="build_bronze_tholos", tri_budget=1600, subdir="Castle/BronzeAge", module="castle_builders_bronze_crypt", era="BronzeAge", zone="Crypt", kind="room"),
...
LATE_CASTLE_SPECS = [
    ...
    # InnerWard
    dict(key="LateCountingHouse", builder="build_late_counting_house", tri_budget=1600, subdir="Castle/LateMedieval", module="castle_builders_late_ward", era="LateMedieval", zone="InnerWard", kind="room"),
    dict(key="LateArmouryHall", builder="build_late_armoury_hall", tri_budget=1600, subdir="Castle/LateMedieval", module="castle_builders_late_ward", era="LateMedieval", zone="InnerWard", kind="room"),
    dict(key="LateSpitKitchen", builder="build_late_spit_kitchen", tri_budget=1600, subdir="Castle/LateMedieval", module="castle_builders_late_ward", era="LateMedieval", zone="InnerWard", kind="room"),
    ...
    # Keep
    dict(key="LateGreatHall", builder="build_late_great_hall", tri_budget=1600, subdir="Castle/LateMedieval", module="castle_builders_late_keep", era="LateMedieval", zone="Keep", kind="room"),
    dict(key="LateJewelHouse", builder="build_late_jewel_house", tri_budget=1600, subdir="Castle/LateMedieval", module="castle_builders_late_keep", era="LateMedieval", zone="Keep", kind="room"),
    dict(key="LateStateBedchamber", builder="build_late_state_bedchamber", tri_budget=1600, subdir="Castle/LateMedieval", module="castle_builders_late_keep", era="LateMedieval", zone="Keep", kind="room"),
    dict(key="LateTapestrySolar", builder="build_late_tapestry_solar", tri_budget=1600, subdir="Castle/LateMedieval", module="castle_builders_late_keep", era="LateMedieval", zone="Keep", kind="room"),
    dict(key="LateTurretStair", builder="build_late_turret_stair", tri_budget=1600, subdir="Castle/LateMedieval", module="castle_builders_late_keep", era="LateMedieval", zone="Keep", kind="room"),
    # Crypt
