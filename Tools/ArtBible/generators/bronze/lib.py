"""Shared helpers for the Bronze Age concept sheets (hand-authored SVG, generated by Python)."""
import math
import random
...
class Sheet:
    ...
    def render(self, ground=(40, 1160)):
        head = ('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 800" width="1200" height="800">\n'
                '  <!-- Plunderspell art bible · The Bronze Age · generated concept sheet. Rules: docs/art/BRIEF.md -->\n')
