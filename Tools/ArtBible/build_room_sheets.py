...
def write_md(era, sheets):
    ...
    out = [f"# {title}: castle rooms\n",
           ...
           f"{era}/*.json`. Do not edit by hand. One sheet per room and curtain-wall piece of "
           f"{title}'s castle set; the models are `Assets/_Project/Art/Models/Castle/{era}/<Key>.fbx`, "
    ...
    for zone in ZONES:
        ...
        for d in zs:
            ...
            if d.get("kit_changes"):
                ...
                out.append("")
            floor = "no floor slab" if d["zone"] == "CurtainWall" else "floor top at 0.30"
