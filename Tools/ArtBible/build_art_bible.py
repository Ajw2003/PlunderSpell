...
Age against docs/art/BRIEF.md and docs/4-systems/scale.md, then writes docs/art/<age>.md and
...
# docs/4-systems/scale.md — clear height above the floor, per zone.
...
def render_age_markdown(age):
    ...
    out = [
        ...
        "[`BRIEF.md`](BRIEF.md). Scale: [`docs/4-systems/scale.md`](../systems/scale.md).",
        "",
        age["intro"],
        "",
        "## Age palette",
