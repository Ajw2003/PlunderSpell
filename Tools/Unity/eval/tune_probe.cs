...
var atmos = RogueAi.Atmosphere.CastleAtmosphere.Instance;
var so = typeof(RogueAi.Atmosphere.CastleAtmosphere).GetField("_profile", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
var profile = (RogueAi.Atmosphere.NightAtmosphereProfile)so.GetValue(atmos);
...
profile.Calm = look;
foreach (var f in RogueAi.Atmosphere.FireSource.All)
{
    var t = typeof(RogueAi.Atmosphere.FireSource);
