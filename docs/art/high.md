...
> Generated by `Tools/ArtBible/build_art_bible.py` from `docs/art/data/high.json`. Edit the JSON, not this file. Rules every entry obeys: [`BRIEF.md`](BRIEF.md). Scale: [`docs/systems/scale.md`](../systems/scale.md).
