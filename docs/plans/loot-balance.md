...
Changed values are **bold**. Since 2026-09-26 the weight lives only in the LootItem's Weight (kg), which sets the body's mass at spawn (`docs/4-systems/damage.md`, "Weight").
